...
$row=mysql_fetch_array($select);
 ...
 ?>
     ...
     <div id="templatemo_main"><span class="main_top"></span> 
          ...
          <p class="welcome_text">&quot;Any Help Click Here.&quot;</p>
  ...
  <tr>
    ...
    <td width="294"><form id="form1" name="form1" method="post" action="">
      <input type="text" name="name" id="textfield" placeholder="Name" required  class="form-control"/>
  ...
  <tr>
    <td>E-Mail</td>
    <td>
      <input type="text" name="email" id="textfield2" placeholder="Email" required  class="form-control" />
  ...
  <tr>
    <td>Phone Number</td>
    <td>
      <input type="text" name="phone" id="textfield2" placeholder="Phone Number" required  class="form-control" />
  ...
  <tr>
    <td>Message</td>
    <td>
      <textarea name="msg" id="textfield2" placeholder="Message" required  class="form-control"></textarea>
...
$insert=mysql_query("insert into message(no,name,email,phone,time,msg,status)values('$no','$name','$email','$phone','$time','$msg','$status')");
}
if($insert)
{
?>
