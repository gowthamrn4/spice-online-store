...
$view=mysql_num_rows($select);
 ...
 <td align="center"><span style="font-size:25px"><?php echo mysql_result($select,$i,"name");?></span></td></div><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <td align="center"><a href="viewcinnamon.php?edit=<?php echo mysql_result($select,$i,"number");?>"><img src="images/img.JPG" /></a>
                       <td align="center"><a href="reviewcin.php?edit=<?php echo mysql_result($select,$i,"number");?>"><big>Add Your Review</big></a>
    </td>
  </tr><br/>
  <br/><br/>
  <br/><br/>
