...
<div class="button"><a href="buy.php?edit=<?php echo mysql_result($select,$i,"number");?>">Buy</a></div>
 ...
 <table width="500" height="141">
  ...
  <tr>   <?php
   $select=mysql_query("select * from reviewclove where number='".$_GET['edit']."'");
   $view=mysql_fetch_array($select);
...
if($button)
 {
$insert=mysql_query("insert into reviewginger(no,name,image,time,review,mark,status)values('$no','$name','$image','$time','$review','$mark','$status')");
}
if($insert)
{
?>
