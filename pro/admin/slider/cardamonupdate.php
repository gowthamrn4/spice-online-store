...
$insert=mysql_query("update cardamom set number='$number',name='$name',price='$price',image='$second',time='$time',place='$place' where number='".$_GET['edit']."'");
}
if($insert)
{
...
<body>
  ...
  <tr><form id="form1" name="form1" method="post" action="" enctype="multipart/form-data"><h1></h1>
    <td>Number</td>
    <td>
      <input type="hidden" name="number" id="number" class="form-control" placeholder="number" value="<?php echo mysql_result($select,0,"number")?> "  required />
