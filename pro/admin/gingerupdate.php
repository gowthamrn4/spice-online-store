...
$insert=mysql_query("update ginger set number='$number',name='$name',price='$price',image='$second',time='$time',place='$place' where number='".$_GET['edit']."'");
}
if($insert)
{
 ...
 ?>
    ...
    <div id="templatemo_menu">
     ...
     <div id="templatemo_main"><span class="main_top"></span> 
          ...
          <p class="welcome_text">&quot; Ginger Update&quot;</p>
<?php
include("db.php");
$select=mysql_query("select * from ginger where number='".$_GET['edit']."'");
$view=mysql_num_rows($select);
