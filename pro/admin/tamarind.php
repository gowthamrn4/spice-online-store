   ...
   ?>
    ...
    <div id="templatemo_menu">
        <ul>
            ...
            <li><a href="tamarind.php"class="current">Tamarind-(<?php echo $view;?>)</a></li>
        </ul> 
    </div> 
     <div id="templatemo_main"><span class="main_top"></span> 
     
     
          <p class="welcome_text">&quot;Tamarind details.&quot;</p>
...
$insert=mysql_query("insert into tamarind(number,name,price,image,time,place)values('$number','$name','$price
','$second','$time','$place')");
}
if($insert)
{
...
$view=mysql_num_rows($select);
 ...
 <tr>
    ...
    <td align="center"><?php echo mysql_result($select,$i,"place");?></td>
        ...
        <td align="center"><a href="tamarindupdate.php?edit=<?php echo mysql_result($select,$i,"number");?>">Edit</a>
