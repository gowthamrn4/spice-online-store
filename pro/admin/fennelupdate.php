<?php
include("db.php");
$select=mysql_query("select * from fennel where number='".$_GET['edit']."'");
...
$insert=mysql_query("update fennel set number='$number',name='$name',price='$price',image='$second',time='$time',place='$place' where number='".$_GET['edit']."'");
}
if($insert)
{
 ...
 ?>
    ...
    <div id="templatemo_menu">
        <ul>
            ...
            <li><a href="fennel.php"class="current">Fennel</a></li>
     ...
     <div id="templatemo_main"><span class="main_top"></span> 
          ...
          <p class="welcome_text">&quot; Fennel Update&quot;</p>
<?php
include("db.php");
$select=mysql_query("select * from Fennel where number='".$_GET['edit']."'");
$view=mysql_num_rows($select);
