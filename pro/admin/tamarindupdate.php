<?php
include("db.php");
$select=mysql_query("select * from tamarind where number='".$_GET['edit']."'");
...
$insert=mysql_query("update tamarind set number='$number',name='$name',price='$price',image='$second',time='$time',place='$place' where number='".$_GET['edit']."'");
}
if($insert)
{
 ...
 ?>
    ...
    <div id="templatemo_menu">
        <ul>
            ...
            <li><a href="tamarind.php"class="current">Tamarind</a></li>
        </ul> 
    </div> 
     <div id="templatemo_main"><span class="main_top"></span> 
     
     
          <p class="welcome_text">&quot; Tamarind Update&quot;</p>
<?php
include("db.php");
$select=mysql_query("select * from tamarind where number='".$_GET['edit']."'");
$view=mysql_num_rows($select);
