<?php
include("db.php");
$select=mysql_query("select * from pepper where number='".$_GET['edit']."'");
...
$insert=mysql_query("update pepper set number='$number',name='$name',price='$price',image='$second',time='$time',place='$place' where number='".$_GET['edit']."'");
}
if($insert)
{
...
$row=mysql_fetch_array($select);
 ...
 ?>
        ...
        <ul>
            ...
            <li><a href="pepper.php" class="current">Pepper</a></li>
    ...
    <div id="templatemo_menu">
     ...
     <div id="templatemo_main"><span class="main_top"></span> 
          ...
          <p class="welcome_text">&quot; Pepper Update&quot;</p>
<?php
include("db.php");
$select=mysql_query("select * from pepper where number='".$_GET['edit']."'");
$view=mysql_num_rows($select);
