...
$select=mysql_query("select * from cinnamon");
   ...
   ?>
        ...
        <ul>
            ...
            <li><a href="cinnamon.php"class="current">Cinnamon-(<?php echo $view;?>)</a></li>
    ...
    <div id="templatemo_menu">
     ...
     <div id="templatemo_main"><span class="main_top"></span> 
          ...
          <p class="welcome_text">&quot;Cinnamon details.&quot;</p>
...
$insert=mysql_query("insert into cinnamon(number,name,price,image,time,place)values('$number','$name','$price
','$second','$time','$place')");
}
if($insert)
{
...
$view=mysql_num_rows($select);
 ...
 <tr>
    ...
    <td align="center"><?php echo mysql_result($select,$i,"place");?></td>
        ...
        <td align="center"><a href="cinnamonupdate.php?edit=<?php echo mysql_result($select,$i,"number");?>">Edit</a>
