...
$select=mysql_query("select * from pay where status=1 ");
   ...
   ?>
     <div id="templatemo_main"><span class="main_top"></span> 
          ...
          <p class="welcome_text"><a href="customer.php">&quot; New Order-(<?php echo $view;?>)&quot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
          <?php
$select=mysql_query("select * from pay where status=0 ");
   $view=mysql_num_rows($select);
   $view1=$view+$count+1;
   for($i=0;$i<$view;$i++)
   ?><a href="totalcustomer.php">Total Orders-(<?php echo $view;?>)</a></p>
...
$view=mysql_num_rows($select);
 ...
 <tr>
    ...
    <td align="center"><a href="customer2.php?edit=<?php echo mysql_result($select,$i,"no");?>">View</a>
  </tr></center>
  <?PHP
  }
  ?>
