...
$insert=mysql_query("update cinnamon set number='$number',name='$name',price='$price',image='$second',time='$time',place='$place' where number='".$_GET['edit']."'");
}
if($insert)
{
 ...
 ?>
    ...
    <div id="templatemo_menu">
     ...
     <div id="templatemo_main"><span class="main_top"></span> 
          ...
          <p class="welcome_text">&quot; Cinnamon Update&quot;</p>
<?php
include("db.php");
$select=mysql_query("select * from cinnamon where number='".$_GET['edit']."'");
$view=mysql_num_rows($select);
