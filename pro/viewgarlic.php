...
<br/>
 ...
 <?php
   ...
   $view=mysql_fetch_array($select);
?>
<div class="button"><a href="buy.php?edit=<?php echo mysql_result($select,$i,"number");?>">Buy</a></div>  <?PHP
$select=mysql_query("select * from reviewga ");
   ...
   <?php echo mysql_result($select,$i,"name");?>
     <big> ((<?php echo mysql_result($select,$i,"review");?> ))</big> <br/>
      <img src="<?php echo mysql_result($select,$i,"image");?>" height="30" width="30"/>
       <?php echo mysql_result($select,$i,"time");?> <br/>
       Rate :  <?php echo mysql_result($select,$i,"mark");?> /5
  <?PHP
  }
  ?> <div style="position: absolute; left: 20px; top: 415px;">
