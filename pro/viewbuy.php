...
<br/>
 ...
 <?php
   ...
   $view=mysql_fetch_array($select);
?>
<div class="button"><a href="buy.php?edit=<?php echo mysql_result($select,$i,"number");?>">Buy</a>
 <?PHP
$select=mysql_query("select * from reviewcardamon ");
 ...
 ?>
   ...
   <?php echo mysql_result($select,$i,"name");?>
     <big> ((<?php echo mysql_result($select,$i,"review");?> ))</big> <br/>
      <img src="<?php echo mysql_result($select,$i,"image");?>" height="30" width="30"/>
  <?PHP
  }
...
if($button)
{
$insert=mysql_query("insert into pay(no,email,name,phone,image,address,proname,img,price,time,cno,month,year,cvc,status)values('$no','$email','$name','$phone','$img','$address','$proname','$image','$price','$time','$cno','$month','$year','$cvc','$status')");
}
if($insert)
{
?>
  ...
  alert('Order successfull');
     	window.location.href='reviewcar.php';
				</script>
<?php
}
else
{
?>
	     <div class="alert alert-success" ><a href="#" class="close" data-dismiss="alert" aria-label="close">x</a> 
